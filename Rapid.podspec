...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Julio Alorro"
  # s.authors            = { "Julio Alorro" => "julio.alorro@ffuf.de" }
  # s.social_media_url   = "http://twitter.com/Julio Alorro"
  ...
  s.source       = { :git => "https://github.com/hooliooo/Rapid.git", :tag => s.version }
